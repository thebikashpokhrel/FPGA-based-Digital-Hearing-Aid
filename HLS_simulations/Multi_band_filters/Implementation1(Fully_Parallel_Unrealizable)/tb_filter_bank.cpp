...
// must match config_bandN::input_length / output_length
...
int main(int argc, char** argv) {
    const char* input_file  = (argc > 1) ? argv[1] : "exports/samples_stereo.txt";
    const char* output_file = (argc > 2) ? argv[2] : "exports/filtered_stereo.txt";
    ...
    while (offset < total_samples) {
        ...
        filter_bank(in_l, in_r, out_l, out_r, BATCH);
